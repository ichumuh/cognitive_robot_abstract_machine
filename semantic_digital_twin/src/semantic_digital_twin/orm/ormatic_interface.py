...
class PlanMappingDAO_nodes_association(Base, AssociationDataAccessObject):
    ...
    __tablename__ = "PlanMappingDAO_nodes_association"

    database_id: Mapped[int] = mapped_column(Integer, primary_key=True)
    source_planmappingdao_id: Mapped[int] = mapped_column(
        ForeignKey("PlanMappingDAO.database_id")
    )
    target_plannodemappingdao_id: Mapped[int] = mapped_column(
        ForeignKey("PlanNodeMappingDAO.database_id")
    )

    target: Mapped[PlanNodeMappingDAO] = relationship(
        "PlanNodeMappingDAO", foreign_keys=[target_plannodemappingdao_id]
    )
...
class PR2DAO_arms_association(Base, AssociationDataAccessObject):
    ...
    __tablename__ = "PR2DAO_arms_association"
...
class SimulatedWorldEntityDAO_simulator_additional_properties_association(
    Base, AssociationDataAccessObject
):

    __tablename__ = (
        "SimulatedWorldEntityDAO_simulator_additional_properties_association"
    )

    database_id: Mapped[int] = mapped_column(Integer, primary_key=True)
    source_simulatedworldentitydao_id: Mapped[int] = mapped_column(
        ForeignKey("SimulatedWorldEntityDAO.database_id")
    )
    target_simulatoradditionalpropertydao_id: Mapped[int] = mapped_column(
        ForeignKey("SimulatorAdditionalPropertyDAO.database_id")
    )
...
class SimulatedWorldEntityDAO(
    WorldEntityWithIDDAO,
    DataAccessObject[
        semantic_digital_twin.world_description.world_entity.SimulatedWorldEntity
    ],
):

    __tablename__ = "SimulatedWorldEntityDAO"
    ...
    simulator_additional_properties: Mapped[
        ...
        collection_class=builtins.list,
        cascade="all, delete-orphan",
        foreign_keys="[SimulatedWorldEntityDAO_simulator_additional_properties_association.source_simulatedworldentitydao_id]",
    )

    __mapper_args__ = {
        "polymorphic_identity": "SimulatedWorldEntityDAO",
        "inherit_condition": database_id == WorldEntityWithIDDAO.database_id,
    }


class ActuatorDAO(
    SimulatedWorldEntityDAO,
    ...
    __mapper_args__ = {
        ...
        "inherit_condition": database_id == SimulatedWorldEntityDAO.database_id,
    }
...
class WorldEntityWithClassIDDAO(
    ...
    __tablename__ = "WorldEntityWithClassIDDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "WorldEntityWithClassIDDAO",
        "inherit_condition": database_id == WorldEntityWithIDDAO.database_id,
    }


class CallbackDAO(
    WorldEntityWithClassIDDAO,
    ...
    database_id: Mapped[builtins.int] = mapped_column(
        ForeignKey(WorldEntityWithClassIDDAO.database_id),
        primary_key=True,
        use_existing_column=True,
    )
    ...
    __mapper_args__ = {
        ...
        "inherit_condition": database_id == WorldEntityWithClassIDDAO.database_id,
    }

        ...
        for idx, (u, v) in enumerate(edges):
            ...
            if edge_style == 'orthogonal':
                def try_hv():
                    ...
                    p2 = (xm, y0)
                    p3 = (xm, y1)
                    if within_x(xm) and not self._seg_blocked(p1, p2, ignore=(u, v)) and not self._seg_blocked(p2, p3, ignore=(u, v)):
                        return [p1, p2, p3]
                    return None
                def try_vh():
                    ym = y1
                    ...
                    p2 = (x0, ym)
                    p3 = (x1, ym)
                    if within_y(ym) and not self._seg_blocked(p1, p2, ignore=(u, v)) and not self._seg_blocked(p2, p3, ignore=(u, v)):
                        return [p1, p2, p3]
                    return None
                def try_vhv():
                    ym = 0.5 * (y0 + y1)
                    ...
                    p3 = (x1, ym)
                    p4 = (x1, y1)
                    if within_y(ym) and (not self._seg_blocked(p1, p2, ignore=(u, v))) and (not self._seg_blocked(p2, p3, ignore=(u, v))) and (not self._seg_blocked(p3, p4, ignore=(u, v))):
                        return [p1, p2, p3, p4]
                    return None

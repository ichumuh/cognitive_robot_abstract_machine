...
def base_bot_urdf():
    with open(
        "../../../../../PycharmProjects/giskardpy/test/urdfs/2d_base_bot.urdf", "r"
    ) as f:
        urdf_string = f.read()
    return urdf_string
...
def donbot_urdf():
    with open(
        "../../../../../PycharmProjects/giskardpy/test/urdfs/iai_donbot.urdf", "r"
    ) as f:
        urdf_string = f.read()
    return urdf_string
...
def boxy_urdf():
    with open(
        "../../../../../PycharmProjects/giskardpy/test/urdfs/boxy.urdf", "r"
    ) as f:
        urdf_string = f.read()
    return urdf_string

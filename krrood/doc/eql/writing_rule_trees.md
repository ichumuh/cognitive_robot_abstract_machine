...
We will construct objects symbolically using symbolic_rule and Add, with var placeholders to describe relationships.
...
```{code-cell} ipython3
from krrood.entity_query_language.entity import entity, variable as var, and_, Symbol, inference
...
revolute_connection = var(type_=RevoluteConnection, domain=world.connections)
